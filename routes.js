...
var apples = require('./controllers/apple');
...
//var assignments = require('./controllers/assignments');
  ...
  app.get('/buy', apples.buy);
  app.get('/api/apples', apples.jsonlist);
  app.get('/apples/:cid', apples.findById);
  app.post('/apples/add', apples.add);
  app.post('/apples/update/:cid', apples.update); 
